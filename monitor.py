...
def readConfig():
	...
	configDict['distance_read_file'] = Files[0]	
	configDict['distance_save_file'] = config.get('Saving', 'distance_save_filename')
	...
	if not os.path.exists(os.path.join(configDict['base_data_directory'],configDict['temperature_save_file'])):
		...
		f.close()
	if not os.path.exists(os.path.join(configDict['base_data_directory'],configDict['distance_save_file'])):
		f = file(os.path.join(configDict['base_data_directory'],configDict['distance_save_file']), "w")
		f.close()
	...
	configDict['distance_sampling_interval'] = int(config.get('Sampling', 'distance_sampling_interval'))
	configDict['distance_sample_length'] = int(config.get('Sampling', 'distance_sample_length'))
